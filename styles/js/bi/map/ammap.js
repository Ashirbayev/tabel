        ...
        brr: function() {
            if (!this.hideCredits) {
                ...
                if (c != a || !0 === this.inIframe()) {
                    ...
                    "ammap" == this.product && (c = a + "/javascript-maps/", b = "Interactive JavaScript maps", e = "");
...
(function() {
    ...
    d.handDrawnLine = function(a, b, c, e, g, f, h, k, l, m) {
        ...
        for (n = 1; n < b.length; n++)
            for (var r = [b[n - 1], b[n]], t = [c[n - 1], c[n]], t = d.makeHD(r, t, a.handDrawScatter), r = t[0], t = t[1], q = 1; q < r.length; q++) p.push(d.line(a, [r[q - 1], r[q]], [t[q - 1], t[q]], e, g, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, h, k, l, m, !0));
        return p
    };
    ...
    d.wedge = function(a, b, c, e, g, f, h, k, l, m, n, p, r, t) {
        ...
        e = a.set();
        var G;
        B && (u = q(10 * u), A = q(10 * A), x = q(10 * x), E = q(10 * E), v = q(10 * v), C = q(10 * C), z = q(10 * z), w = q(10 * w), b = q(10 * b), l = q(10 * l), c = q(10 * c), f *= 10, h *= 10, k *= 10, y *= 10, 1 > Math.abs(g) && 1 >= Math.abs(x - A) && 1 >= Math.abs(z - C) && (G = !0));
        g = "";
        var D;
        p && (F["fill-opacity"] = 0, F["stroke-opacity"] = m["stroke-opacity"] / 2, F.stroke = m.stroke);
        if (0 < l) {
            D = " M" + u + "," + (v + l) + " L" + A + "," + (C + l);
            B ? (G || (D += " A" + (b - f) + "," + (l + c - h) + "," + (b + f) + "," + (l + c + h) + "," + A + "," + (C + l) + "," + x + "," + (z + l)), D += " L" + E + "," + (w + l), 0 < k && (G || (D += " B" + (b - k) + "," + (l + c - y) + "," + (b + k) + "," + (l + c + y) + "," + E + "," + (l + w) + "," + u + "," + (l + v)))) : (D += " A" + f + "," + h + ",0," + H + ",1," + x + "," + (z + l) + " L" + E + "," + (w + l), 0 < k && (D += " A" + k + "," + y + ",0," + H + ",0," + u + "," + (v + l)));
            D += " Z";
            var L = l;
            B && (L /= 10);
        ...
        B ? (G || (g = " A" + q(b - f) + "," + q(c - h) + "," + q(b + f) + "," + q(c + h) + "," + q(A) + "," + q(C) + "," + q(x) + "," + q(z)), h = " M" + q(u) + "," + q(v) + " L" + q(A) + "," + q(C) + g + " L" + q(E) + "," + q(w)) : h = " M" + u + "," + v + " L" + A + "," + C + (" A" + f + "," + h + ",0," + H + ",1," + x + "," + z) + " L" + E + "," + w;
    ...
    d.AmMap = d.Class({
        ...
        handleMouseMove: function(a) {
            ...
            if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                ...
                if (a = b.mapContainer) {
                    ...
                    k = a.scale;
                    b.isDragging && (b.balloon.hide(0), b.positionChanged(), c = a.x + (g - c), e = a.y + (f - e), b.preventDragOut && (r = -r * k + m / 2 - b.diffY * b.mapScale * k, m = m / 2 - b.diffY * b.mapScale * k, c = d.fitToBounds(c, -p * k + n / 2, n / 2), e = d.fitToBounds(e, r, m)), isNaN(c) || isNaN(e) || (a.translate(c, e, k, !0), b.updateSmallMap()));
                    b.previuosMouseX = g;
                    b.previuosMouseY = f
                }
            }
        ...
        zoomToRectangle: function(a, b, c, e) {
            var g = this.realWidth,
                ...
                h = this.mapSet.scale,
                k = this.zoomControl,
                g = d.fitToBounds(c / g > e / f ? .8 * g / (c * h) : .8 * f / (e * h), k.minZoomLevel, k.maxZoomLevel);
        ...
        zoomToLatLongRectangle: function(a, b, c, e) {
            var g = this.dataProvider,
                ...
                f = d.fitToBounds(h / l > k / g ? .8 * l / h : .8 * g / k, f.minZoomLevel, f.maxZoomLevel);
        ...
        milesToPixels: function(a) {
            ...
            return this.mapWidth /
                (b.rightLongitude - b.leftLongitude) * a / 69.172
        },
        ...
        xyToCoordinates: function(a,
            ...
            if (f = c.invert) {
                var h = this.dataProvider.leftLongitude,
                    ...
                    k = d.radiansToDegrees(c(d.degreesToRadians(k),
...
(function() {
    ...
    d.ZoomControl = d.Class({
        ...
        init: function(a, b) {
            ...
            isNaN(c.bottom) || (z = a.getY(c.bottom, !0), f && (z -= q + 3 * g), z = h ? z - 3 * g : c.homeButtonEnabled ? z - .5 * g : z + g);
            e.translate(x, z);
            c.previousDY = NaN;
            var E, x = g / 4 - 1;
            if (f) {
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                if (0 < v.length) {
                    ...
                    if ("none" != A) {
                        ...
                        "both" == A && (r = d.polygon(x, t, k, m, p, 1, m, p, void 0, !0), z.push(r), r.translate(K, N, 1 / n, !0), isNaN(I) || r.rotate(I), d.setCN(c, q, "map-line-arrow"), void 0 != a.id && d.setCN(c, q, "map-line-arrow-" + a.id), a.fixedSize && g.push(r));
        ...
        init: function(a, b) {
            if (this.enabled) {
                ...
                if (this.showAsGradient) c = d.rect(b, this.width, this.height, [c, e], 1, this.borderThickness, this.borderColor, 1, 0, 0), d.setCN(a, c, "value-legend-gradient"), c.translate(0, h), f.push(c);
                    ...
                    for (l = this.width / g, m = 0; m < g; m++) n = d.getColorFade(c, e, 1 * m / (g - 1)), n = d.rect(b, l, this.height, n, 1, this.borderThickness, this.borderColor, 1), d.setCN(a, n, "value-legend-color"), d.setCN(a, n, "value-legend-color-" + m), n.translate(l * m, h), f.push(n);
                e = c = 0;
                g = f.getBBox();
