        ...
        palette = renderer.create('<div class="note-color-palette"/>', function(a, b) {
            for (var c = [], d = 0, e = b.colors.length; e > d; d++) {
                for (var f = b.eventName, g = b.colors[d], h = [], i = 0, j = g.length; j > i; i++) {
                    var k = g[i];                    
                    h.push(['<button type="button" class="note-color-btn"', 'style="background-color2:', k, '" ', 'data-event="', f, '" ', 'data-value="', k, '" ', 'title="', k, '" ', 'data-toggle="button" tabindex="-1"></button>'].join(""))
                }
                    ...
                    return c.buttonGroup({
                        ...
                        children: [c.button({
                            ...
                            callback: function(a) {
                                ...
                                b.css("background-color2", "#FFFF00"), a.attr("data-backColor", "#FFFF00")
                            }
                        }), c.button({
                            className: "dropdown-toggle",
                            ...
                            click: function(b) {
                                var c = $(b.target),
                                    ...
                                    e = c.data("value");                                    
                                if (d && e) {                                    
                                    var f = "backColor" === d ? "background-color2" : "color",
