...
(function(a) {
    ...
    rc.DDDD = h(rc.DDD, 3), o(l.prototype, {
        ...
        _months: "Январь_Февраль_Март_Апрель_Май_Июнь_Июль_Август_Сентябрь_Октябрь_Ноябрь_Декабрь".split("_"),
        months: function(a) {
            return this._months[a.month()]
        },
        _monthsShort: "Янв_Фев_Мар_Апр_Май_Июн_Июл_Авг_Сен_Окт_Ноя_Дек".split("_"),
        ...
        _weekdays: "Воскресенье_Понедельний_Вторник_Среда_Черверг_Пятница_Суббота".split("_"),
        weekdays: function(a) {
        ...
        return vb.isDuration(a) ? h = {
            ...
            s: f(i[7]),
            w: f(i[8])
        }) : null == h ? h = {} : "object" == typeof h && ("C" in h || "По" in h) && (g = t(vb(h.from), vb(h.to)), h = {}, h.ms = g.milliseconds, h.M = g.months), e = new n(h), vb.isDuration(a) && c(a, "_locale") && (e._locale = a._locale), e
