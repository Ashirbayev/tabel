...
$(document).ready(function() {
    ...
    $("#side-menu").metisMenu(), $(".collapse-link").click(function() {
        var e = $(this).closest("div.ibox"),
            o = $(this).find("i"),
            i = e.find("div.ibox-content");
        i.slideToggle(200), o.toggleClass("fa-chevron-up").toggleClass("fa-chevron-down"), e.toggleClass("").toggleClass("border-bottom"), setTimeout(function() {
        ...
        container: "body"
    }), $(".modal").appendTo("body"), e(), $(window).bind("load resize click scroll", function() {
