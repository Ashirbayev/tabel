<?php
    ...
    $sql_transf = "select
                        CARD.EVENT_START_DATE, CARD.ID_PERSON, CARD.EVENT_DATE, CARD.ID, CARD.SALARY, DOLZH.D_NAME DOLZH, DOLZH.D_NAME_KAZ D_NAME_KAZ, BRANCH.NAME BRANCHNAME, BRANCH.NAME_KZ BRANCHNAME_KAZ, DEP.NAME DEP_NAME, DEP.NAME_KAZ DEP_NAME_KAZ
    ...
    */
    ...
    $sql_transf2 = "select
                        CARD.EMP_ID, CARD.EVENT_DATE, CARD.ID, CARD.SALARY, DOLZH.D_NAME DOLZH, DOLZH.D_NAME_KAZ D_NAME_KAZ, BRANCH.NAME BRANCHNAME, BRANCH.NAME_KZ BRANCHNAME_KAZ, DEP.NAME DEP_NAME, DEP.NAME_KAZ DEP_NAME_KAZ
                        from T2_CARD CARD, DIC_DOLZH DOLZH, DIC_BRANCH BRANCH, DIC_DEPARTMENT DEP
                        where CARD.BRANCH_ID = BRANCH.RFBN_ID and CARD.DEPARTMENT = DEP.ID and CARD.POSITION = DOLZH.ID and CARD.ID = $last_transf_id";
    //echo $sql_transf2;
    //exit;
    ...
    $LAST_DOLZH_KAZ = $list_transf2[0]['D_NAME_KAZ'];
    $LAST_BRANCHNAME = $list_transf2[0]['BRANCHNAME'];
    $LAST_BRANCHNAME_KAZ = $list_transf2[0]['BRANCHNAME_KAZ'];
    $LAST_DEP_NAME = $list_transf2[0]['DEP_NAME'];
    $LAST_DEP_NAME_KAZ = $list_transf2[0]['DEP_NAME_KAZ'];
    ...
    <div border="0" cellpadding="0" cellspacing="0" width="100%" style="font-family: "Times New Roman", Times, serif; 
                ...
                line-height: 1.0;">
                    <p>
                        ...
                        <font face="verdana">
                            <strong>'.$name_first_simb.'. '.$middlename_first_simb.'. '.$lastname.' ауыстыру туралы</strong><br>
                        </font>
                        </div>
                        </p><div align="justify" style="text-indent: 30px; line-height: 1.0; font-size: 14pt; text-align: justify;">
                            <font face="verdana">
                                «Мемлекеттік аннуитеттік компания» өмірді сақтандыру компаниясы» АҚ  Жарғысынң 14-Тарауы 116-тармағының 5)-тармақшасына сәйкес, <strong>БҰЙЫРАМЫН:</strong><br>
                            </font>
                        </div>
                        <div style="text-indent: 30px; font-size: 14pt; line-height: 1.0; text-align: justify;">
                            <font face="verdana">
                                1. '.$name.' '.$middlename.' '.$lastname.' '.$LAST_DEP_NAME_KAZ.' '.$LAST_BRANCHNAME_KAZ.' '.$LAST_DOLZH_KAZ.' лауазымынан '.$DEP_NAME_KAZ.' '.$BRANCHNAME_KAZ.' '.$DOLZH_KAZ.' лауазымына '.$EVENT_START_DATE.' ж. '.$OKLAD.' ('.num3str($OKLAD).') теңге лауазымдық жалақымен ауыстырылсын.
                            </font>
                        </div>
                        <div style="text-indent: 30px; font-size: 14pt; line-height: 1.0; text-align: justify;">
                            <font face="verdana">
                                2. Персоналды басқару бойынша бас маман '.$name_first_simb.'. '.$middlename_first_simb.'. '.$lastname.' Еңбек шартына тиісті өзгерістерді енгізсін.
                            </font>
                        </div>
                        <div style="text-indent: 30px; font-size: 14pt; line-height: 1.0; text-align: justify;">
                            <font face="verdana">
                        ...
                        <div style="text-indent: 30px; font-size: 14pt; line-height: 1.0; text-align: justify;">
                            <font face="verdana">
                                4. Осы бұйрық қол қойған күннен бастап өзінің күшіне еңеді.
                            </font>
                        </div>
                        <div style="text-indent: 30px; font-size: 14pt;">
                            <font face="verdana">
                                Негіздеме: '.$name_first_simb.'. '.$middlename_first_simb.'. '.$lastname.' өтініші.
                            </font>
                        </div>
    ...
    <div border="0" cellpadding="0" cellspacing="0" width="100%" style="font-family: "Times New Roman", Times, serif; 
                ...
                line-height: 1.1;">
                        <div style="font-size: 14pt; ">
                           <font face="verdana">
                                <strong>О переводе '.$lastname.' '.$name_first_simb.'. '.$middlename_first_simb.'.</strong><br>
                            </font>
                        </div>
                            <br>
                        <div style="text-indent: 30px; font-size: 14pt; line-height: 1.0; text-align: justify;">
                        ...
                        <div style="text-indent: 30px; font-size: 14pt; line-height: 1.0; text-align: justify;">
                            <font face="verdana">
                                1. Перевести '.$lastname.' '.$name.' '.$middlename.' c должности '.$LAST_DOLZH.' '.$LAST_BRANCHNAME.' '.$LAST_DEP_NAME.'  на должность '.$DOLZH.' '.$BRANCHNAME.' '.$DEP_NAME.' с должностным окладом '.$OKLAD.' ('.num2str($OKLAD, true).') тенге с '.$EVENT_START_DATE.' г.
                            <font face="verdana">
                        ...
                        <div style="text-indent: 30px; font-size: 14pt;">
                            <font face="verdana">
                                Основание: заявление '.$lastname.' '.$name_first_simb.'. '.$middlename_first_simb.'.
                            </font>
                        </div>
                        <br><br>
                        <div style="text-indent: 30px; font-size: 14pt;">
    ...
    Е. Хасенов</strong>
                        ...
                        <font face="verdana">
                            Бұйрықпен таныстырылды:
                                ...
                                <br><br>
                        <font face="verdana">
                            '.$name_first_simb.'. '.$middlename_first_simb.'. '.$lastname.' _____________ 2019 жылғы «___» _________
                        </font>
                    <p></p>
    </font></font></div>
            ';
