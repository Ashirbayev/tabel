<?php
    ...
    if(isset($_POST['BRANCH_NAME']))
    {
        ...
        $sql = "insert into DIC_BRANCH (RFBN_ID, NAME_KZ, NAME, COMPANY_ID) values ('', '$NAME_KAZ', '$BRANCH_NAME', '$COMPANY_ID')";
    ...
    $sql = "select * from DIC_BRANCH where COMPANY_ID = '$company_id' order by RFBN_ID";
