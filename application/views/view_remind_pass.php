...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
            ...
            <p>Для восстановления пароля, необходимо ввести почту, указанную в Вашей учетной записи</p>
            <form class="m-t" role="form" method="post" autocomplete="off">
                <div class="form-group">      
                    <input type="text" <?php //echo $s; ?> autocomplete="on" class="form-control" placeholder="E-MAIL" name="login"/>
                </div>
                <input type="hidden" name="url_request" value="<?php echo $_SERVER['REQUEST_URI']; ?>"/>
                <input type="submit" class="btn btn-primary block full-width m-b" value="Отправить"/>
            </form>
